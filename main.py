...
# database
# db["Sharil, Mohd"] = "0123456789"
# print(db["Sharil, Mohd"])

# dictionary
# d = {}
# d["Sharil, Mohd"] = "0123456789"
# print(d["Sharil, Mohd"])
...
def prompt_update_contact():
  ...
  if old_number:
    new_name = input(
      f"Please enter the new name for the this contact (leave blank to keep {old_name}): "
    ).strip()
    new_number = input(
      f"Please enter the number for this contact (leave blank to keep {old_number}): "
    ).strip()
